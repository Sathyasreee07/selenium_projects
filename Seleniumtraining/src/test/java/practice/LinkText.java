...
//		Thread.sleep(6000);
//		driver.findElement(By.cssSelector("[placeholder='First Name']")).sendKeys("Tamil");
//		driver.findElement(By.cssSelector("[placeholder='Last Name']")).sendKeys("selvi");
		
//		driver.get("https://www.youtube.com/");
//		Thread.sleep(2000);
//		driver.findElement(By.name("search_query")).sendKeys("un per sola asaithan");
...
//		Thread.sleep(2000);
//		
//		driver.findElement(By.xpath("//input[ends-with(@id,'h-ac')]")).sendKeys("Toy");
		
		
		//add
//		driver.get("https://www.ebay.com/");
//		Thread.sleep(2000);		
//		driver.findElement(By.xpath("//a[@class='vl-flyout-nav__link-container' and @_sp='p4624852.m1379.l3250' and @href='https://www.ebay.com/b/Auto-Parts-and-Vehicles/6000/bn_1865334']")).click();
